  ...
  return (
    <section className="py-24 px-6 md:px-12 max-w-6xl mx-auto w-full">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center p-16 md:p-24 text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-4 drop-shadow-md">
            How Can I Help?
          </h2>
